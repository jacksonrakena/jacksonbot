...
namespace Rosalina
{
    ...
    {
        private readonly RosalinaConfig _config;
        ...
        public HelpService(RosalinaConfig config)
        {
            _config = config;
        }
        ...
        public static async Task<bool> CanShowCommandAsync(RosalinaCommandContext context, Command command)
        {
        ...
        public static async Task<bool> CanShowModuleAsync(RosalinaCommandContext context, Qmmands.Module module)
        {
        ...
        public static LocalEmbedBuilder CreateGroupEmbed(RosalinaCommandContext context, Qmmands.Module group)
        {
        ...
        public static string GetCommandUsage(RosalinaCommandContext context, Command command)
        {
        ...
        public static string GetFriendlyName(Parameter info, CommandService commandService)
        {
            ...
            else
            {
                ...
                if (rawParserObject != null)
                {
                    ...
                    if (parserType.BaseType != null && typeof(RosalinaTypeParser<>).IsAssignableFrom(parserType.BaseType.GetGenericTypeDefinition()))
                    {
        ...
        public async Task<LocalEmbedBuilder> CreateCommandEmbedAsync(Command command, RosalinaCommandContext context)
        {
        ...
        private async Task<string> FormatCheck(CheckAttribute cba, RosalinaCommandContext context)
        {
        ...
        public static string GetParameterCheckFriendlyMessage(RosalinaCommandContext context, ParameterCheckAttribute pca)
        {
            if (pca is IRosalinaCheck iac) return iac.GetDescription(context);
            string? message = null;
            switch (pca)
            {
        ...
        public static string GetCheckFriendlyMessage(RosalinaCommandContext context, CheckAttribute cba)
        {
            if (cba is IRosalinaCheck iac) return iac.GetDescription(context);
        ...
        private static string FormatParameter(RosalinaCommandContext ctx, Parameter parameterInfo)
        {
        ...
        private static string FormatParameterTags(RosalinaCommandContext ctx, Parameter parameterInfo)
        {
