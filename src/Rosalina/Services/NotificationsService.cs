...
namespace Rosalina
{
    ...
    {
        private readonly RosalinaConfigNotificationsSection? _notifyConfig;
        private readonly RosalinaBot _abyss;

        public NotificationsService(RosalinaBot abyss, RosalinaConfig config)
        {
