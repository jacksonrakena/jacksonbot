...
namespace Rosalina
{
    ...
    public class ModeratorModule : RosalinaModuleBase
    {
        ...
        public async Task<RosalinaResult> BanUserAsync(
        ...
        public async Task<RosalinaResult> Command_KickUserAsync(
        ...
        [RequireMemberGuildPermissions(Permission.BanMembers)]
        [RequireBotGuildPermissions(Permission.BanMembers)]
        public async Task<RosalinaResult> Command_HackBanUserAsync(
            [Name("Victim")] [Description("The user to ban.")] [MustNotBeBot] [MustNotBeInvoker]
            Snowflake target,
            [Name("Ban Reason")] [Description("The audit log reason for the ban.")] [Remainder] [Maximum(50)]
            string? reason = null)
        ...
        [RequireBotGuildPermissions(Permission.BanMembers)]
        [RequireMemberGuildPermissions(Permission.BanMembers)]
        public async Task<RosalinaResult> Command_GetBansListAsync()
        {
        ...
        [RequireMemberGuildPermissions(Permission.KickMembers)]
        [RequireBotGuildPermissions(Permission.BanMembers)]
        public async Task<RosalinaResult> Command_SoftbanAsync([Name("Target")] [Description("The user to softban.")] [MustNotBeBot, MustNotBeInvoker] CachedMember user)
        {
        ...
        public async Task<RosalinaResult> Command_ClearAllAsync(
