...
namespace Rosalina
{
    ...
    public class SpotifyModule : RosalinaModuleBase
    {
        ...
        [RunMode(RunMode.Parallel)]
        public async Task<RosalinaResult> Command_TrackAsync(
            [Name("Track Name")]
        ...
        [RunMode(RunMode.Parallel)]
        public async Task<RosalinaResult> Command_SearchAlbumAsync(
            [Name("Album Name")]
