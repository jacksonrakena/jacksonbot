...
namespace Rosalina
{
    ...
    [BotOwnerOnly]
    public class SystemCommandGroup : RosalinaModuleBase
    {
        [Command("throwex")]
        [Description("Throws a InvalidOperation .NET exception. For testing purposes.")]
        public Task<RosalinaResult> Command_ThrowExceptionAsync([Name("Message")] [Description("The message for the exception.")] [Remainder] string message = "Test exception.")
        {
        ...
        public RosalinaResult Command_HandlebarsEvaluate([Name("Template")] [Description("A Handlebars-compatible template.")] [Remainder]
            string script)
        {
        ...
        public async Task<RosalinaResult> Command_AnnounceAsync([Name("Channel")] [Description("The channel to send to.")]
            ...
            [Name("Message")] [Description("The message.")] [Remainder] string message)
        {
            return await channel.TrySendMessageAsync(string.Empty, false, 
                    ...
                    .WithColor(RosalinaBot.SystemColor)
                    .WithTitle(title)
        ...
        public async Task<RosalinaResult> Command_EvaluateAsync(
        ...
        public Task<RosalinaResult> Command_InspectObjectAsync(
        ...
        [BotOwnerOnly]
        public async Task<RosalinaResult> Command_EditAsync([Name("Message")] [Description("The message to edit.")]
        ...
        [BotOwnerOnly]
        [RunMode(RunMode.Parallel)]
        public async Task<RosalinaResult> Command_ExecuteAsync([Name("Executable")] [Description("The executable to run.")] string executable,
