...
namespace Rosalina
{
    ...
    public class MetaModule : RosalinaModuleBase
    {
        private readonly ICommandService _commandService;
        private readonly RosalinaConfig _config;
        private readonly RosalinaBot _bot;

        public MetaModule(RosalinaBot bot, ICommandService commandService, RosalinaConfig config)
        {
        ...
        public Task<RosalinaResult> Command_GetUptimeAsync()
        {
        ...
        public Task<RosalinaResult> Command_GetVersionInfoAsync()
        {
            var dotnetVersion =
                Assembly.GetEntryAssembly()?.GetCustomAttribute<TargetFrameworkAttribute>()?.FrameworkName ??
                ".NET Core";

            var fwAssembly = Assembly.GetAssembly(typeof(RosalinaBot))!;
        ...
        public async Task<RosalinaResult> Command_GetRosalinaInfoAsync()
        {
            var app = await Context.Bot.GetCurrentApplicationAsync().ConfigureAwait(false);
            var response = new LocalEmbedBuilder
            {
                Description = string.IsNullOrEmpty(app.Description) ? "Thank you for using Rosalina. Here's a little information about me." : app.Description,
            ...
            response
                ...
                .AddField("Source", Markdown.Link("abyssal/Rosalina", "https://github.com/abyssal/Rosalina"), true)
        ...
        public Task<RosalinaResult> Command_HasPermissionAsync(
