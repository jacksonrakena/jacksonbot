...
namespace Rosalina
{
    ...
    public class PicturesModule : RosalinaModuleBase
    {
        ...
        [Command("cat")]
        [Description("Meow.")]
        [RosalinaCooldown(1, 5, CooldownMeasure.Seconds, CooldownType.User)]
        public async Task<RosalinaResult> Command_GetCatPictureAsync()
        {
        ...
        [RosalinaCooldown(1, 5, CooldownMeasure.Seconds, CooldownType.User)]
        public async Task<RosalinaResult> Command_GetBigEmojiAsync([Name("Emoji")] [Description("The emoji to enlarge.")]
        ...
        [RosalinaCooldown(1, 30, CooldownMeasure.Seconds, CooldownType.User)]
        [RunMode(RunMode.Parallel)]
        public async Task<RosalinaResult> Command_ResizeImageAsync(
