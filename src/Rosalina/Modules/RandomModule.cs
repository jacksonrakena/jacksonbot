...
namespace Rosalina
{
    ...
    public class RandomModule : RosalinaModuleBase
    {
        ...
        public Task<RosalinaResult> Command_OtpAsync()
        {
            try
            {
        ...
        public Task<RosalinaResult> Command_DiceRollAsync(
            [Name("Dice")]
        ...
        public Task<RosalinaResult> IsUserAsync(CachedMember target, [Remainder] string attribute)
        {
        ...
        public Task<RosalinaResult> DoesUserAsync(CachedMember target, [Remainder] string attribute)
        {
        ...
        public Task<RosalinaResult> Command_PickOptionAsync(
