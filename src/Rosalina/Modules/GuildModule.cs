...
namespace Rosalina
{
    ...
    public class GuildModule : RosalinaModuleBase
    {
        [Command("server", "serverinfo")]
        [Description("Grabs information around this server.")]
        public Task<RosalinaResult> Command_GuildInfoAsync()
        {
            var embed = new LocalEmbedBuilder
            {
                Color = RosalinaBot.SystemColor,
            ...
            embed.AddField("Rosalina added", FormatHelper.FormatTime(Context.BotMember.JoinedAt), true);
        ...
        public async Task<RosalinaResult> Command_GetColourFromRoleAsync(
        ...
        [RunMode(RunMode.Parallel)]
        public Task<RosalinaResult> Command_GetColourFromUserAsync(
        ...
        public Task<RosalinaResult> Command_ShowPermissionsAsync(
            [Name("Target")]
        ...
        public Task<RosalinaResult> Command_CreateChannelTreeAsync()
        {
        ...
        public Task<RosalinaResult> Command_AnalyzePermissionAsync(
