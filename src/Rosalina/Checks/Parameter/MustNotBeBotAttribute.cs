...
namespace Rosalina
{
    ...
    public sealed class MustNotBeBotAttribute : ParameterCheckAttribute, IRosalinaCheck
    {
        public override ValueTask<CheckResult> CheckAsync(object argument, CommandContext context)
        {
            ...
            return id == context.AsRosalinaContext().Bot.CurrentUser.Id
                ? new CheckResult("The provided user can't be me.")
                : CheckResult.Successful;
        }

        public string GetDescription(RosalinaCommandContext requestContext) => "The provided user can't be me.";
