...
namespace Abyss.Core.Extensions
{
    ...
    {
        public static async Task<bool> TrySendMessageAsync(this IMessageChannel messageChannel, string message = null,
        ...
        public static ITextChannel GetDefaultChannel(this SocketGuild guild)
        {
            ...
            return firstOrDefault ??
                   guild.TextChannels.FirstOrDefault(c => guild.CurrentUser.GetPermissions(c).SendMessages);
        }
