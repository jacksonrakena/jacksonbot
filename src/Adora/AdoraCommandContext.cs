...
{
    /// <summary>
    ///     Represents a request context for an Adora command request.
    /// </summary>
    public class AdoraCommandContext : DiscordCommandContext, IServiceProvider
    {
        internal AdoraCommandContext(AdoraBot bot, CachedUserMessage message, IPrefix prefix) : base(bot, prefix, message)
        {
            Bot = bot;
