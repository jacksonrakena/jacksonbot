...
namespace Adora
{
    public sealed class HelpService
    {
        ...
        public static async Task<bool> CanShowCommandAsync(AdoraCommandContext context, Command command)
        {
        ...
        public static async Task<bool> CanShowModuleAsync(AdoraCommandContext context, Qmmands.Module module)
        {
        ...
        public static LocalEmbedBuilder CreateGroupEmbed(AdoraCommandContext context, Qmmands.Module group)
        {
        ...
        public static string GetCommandUsage(AdoraCommandContext context, Command command)
        {
        ...
        public static string GetFriendlyName(Parameter info, CommandService commandService)
        {
            ...
            else
            {
                ...
                if (rawParserObject != null)
                {
                    ...
                    if (parserType.BaseType != null && typeof(AdoraTypeParser<>).IsAssignableFrom(parserType.BaseType.GetGenericTypeDefinition()))
                    {
        ...
        {
            if (pca is IAdoraCheck iac) return iac.GetDescription(context);
            string? message = null;
            switch (pca)
            {
        ...
        public static string GetCheckFriendlyMessage(AdoraCommandContext context, CheckAttribute cba)
        {
            if (cba is IAdoraCheck iac) return iac.GetDescription(context);
        ...
        private static string FormatParameter(AdoraCommandContext ctx, Parameter parameterInfo)
        {
        ...
        private static string FormatParameterTags(AdoraCommandContext ctx, Parameter parameterInfo)
        {
