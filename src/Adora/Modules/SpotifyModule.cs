...
namespace Adora
{
    ...
    public class SpotifyModule : AdoraModuleBase
    {
        ...
        public async Task<AdoraResult> Command_ArtistAsync(
        ...
        [RunMode(RunMode.Parallel)]
        public async Task<AdoraResult> Command_TrackAsync(
            [Name("Track Name")]
        ...
        [RunMode(RunMode.Parallel)]
        public async Task<AdoraResult> Command_SearchAlbumAsync(
            [Name("Album Name")]
