...
namespace Adora
{
    ...
    public class RandomModule : AdoraModuleBase
    {
        ...
        public Task<AdoraResult> Command_OtpAsync()
        {
            try
            {
        ...
        public Task<AdoraResult> Command_DiceRollAsync(
            [Name("Dice")]
        ...
        public Task<AdoraResult> IsUserAsync(CachedMember target, [Remainder] string attribute)
        {
        ...
        public Task<AdoraResult> DoesUserAsync(CachedMember target, [Remainder] string attribute)
        {
        ...
        public Task<AdoraResult> Command_PickOptionAsync(
