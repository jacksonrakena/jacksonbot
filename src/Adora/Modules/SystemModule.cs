...
namespace Adora
{
    ...
    public class SystemModule : AdoraModuleBase
    {
        ...
        public async Task<AdoraResult> Command_EvaluateAsync(
        ...
        public Task<AdoraResult> Command_InspectObjectAsync(
        ...
        [BotOwnerOnly]
        public async Task<AdoraResult> Command_EditAsync([Name("Message")] [Description("The message to edit.")]
        ...
        [BotOwnerOnly]
        [RunMode(RunMode.Parallel)]
        public async Task<AdoraResult> Command_ExecuteAsync([Name("Executable")] [Description("The executable to run.")] string executable,
