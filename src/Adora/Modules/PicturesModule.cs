...
namespace Adora
{
    ...
    public class PicturesModule : AdoraModuleBase
    {
        ...
        [Command("cat")]
        [Description("Meow.")]
        [AdoraCooldown(1, 5, CooldownMeasure.Seconds, CooldownType.User)]
        public async Task<AdoraResult> Command_GetCatPictureAsync()
        {
        ...
        [AdoraCooldown(1, 5, CooldownMeasure.Seconds, CooldownType.User)]
        public async Task<AdoraResult> Command_GetBigEmojiAsync([Name("Emoji")] [Description("The emoji to enlarge.")]
        ...
        [AdoraCooldown(1, 30, CooldownMeasure.Seconds, CooldownType.User)]
        [RunMode(RunMode.Parallel)]
        public async Task<AdoraResult> Command_ResizeImageAsync(
